          ...
          <div className='container'>
              ...
              <div className='py-8 px-4'>
                      ...
                      text-justify mb-3 flex items-center gap-3'>
                          ...
                          PixelWear</h1>
                  <p className='font-extralight'>PixelWear is a premier clothing brand that combines
                      cutting-edge design with exceptional quality.
                      Our mission is to provide stylish and comfortable apparel that
                      empowers
